	...
	<body>
		...
		<div>
			...
			<div class="img-1" style="max-width: 100%px;">
				...
				<div class="centered">
					<p style="font-size : 20px">Cari Lapangan Futsal?<?php echo $sess['status_menyewa'];?></p>
					...
					<?php foreach($data_lp_rekom as $dt_rekom){?> 
						<div class="col-3 rw1" style="margin : 2% 7% 2% 0;">
							...
							<div class="row container">
								...
								<div class="col-6">
									<button type="button" class="btn bnn bnn2" data-toggle="modal" data-target="#pesan_rekom<?php echo $dt_rekom->id_lapangan;?>">
										Pesan Lapangan
									</button>
								</div>
							</div>
									...
									<div class="row">
										...
										<div class="col-5">
											<div class="form-group">
												...
												<input id="nama_l"readonly class="form-control" value="<?php echo $dt_rekom->nama_lapangan;?>">
											</div>	
											<div class="form-group">
												<label for="jenis_l">Jenis Lapangan</label>
												<input id="jenis_l"readonly class="form-control" value="<?php echo $dt_rekom->jenis_lapangan;?>">
											</div>	
											<div class="form-group">
												<label for="deskrip_l">Deskripsi Lapangan</label>
												<textarea id="deskrip_l"readonly class="form-control" ><?php echo $dt_rekom->deskripsi;?></textarea>
											</div>
											<div class="form-group">
												<label for="alamat_l">Alamat Lapangan</label>
												<textarea id="alamat_l"readonly class="form-control" ><?php echo $dt_rekom->alamat_lapangan;?></textarea>
											</div>
											<div class="form-group">
												<label for="harga_l">Harga Sewa Lapangan</label>
												<input id="harga_l" readonly class="form-control" value="Rp.<?php echo $dt_rekom->harga;?>/Jam">
											</div>
											<div class="form-group">
												<label for="no_hpL">No Handphone</label>
												<input id="no_hpL" readonly class="form-control" value="<?php echo $dt_rekom->nohp_pemilik;?>">
											</div>
										</div>
									</div>
								  </div>
						...
						<!-- Modal Pesan Lapangan Rekomendasi-->
						<div class="modal fade" id="pesan_rekom<?php echo $dt_rekom->id_lapangan;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								...
								<div class="modal-content">
									<div class="modal-header">
										...
										<div class="modal-body">
											...
											<input type="hidden" name="id_lapangan" value="<?php echo $dt_rekom->id_lapangan;?>">
											<input type="hidden" name="biaya" value="<?php echo $dt_rekom->harga;?>">
						...
						<!-- End Modal Pesan Lapangan Rekomendasi--> 
					<?php }?>
					</div>
				</div>
			</div>
					...
					<?php foreach($data_lp as $dt){?> 
						<div class="col-3 rw1" style="margin : 2% 7% 2% 0;">
							...
							<div class="row container">
								...
								<div class="col-6">
									<button type="button" class="btn bnn bnn2" data-toggle="modal" data-target="#pesan_favorit<?php echo $dt_rekom->id_lapangan;?>">
										Pesan Lapangan
									</button>
								</div>
							</div>
						...
						<!-- End Modal Pesan Lapangan Favorit-->
					<?php }?>
					</div>
				</div>
			</div>
