<html>
	...
	<body>
			...
			<?php foreach($data_lapangan as $dt){?> 
				<div class="col-3 rw1" style="margin : 2% 7% 2% 0;">
					...
					<div class="col-6 container">
						<button type="button" class="btn btn-outline-success bnn bnn1" data-toggle="modal" data-target="#detail_rekom<?php echo $dt->id_lapangan;?>">
							Detail Lapangan
						</button>
					</div>
				</div>
				...
				<div class="modal fade" id="detail_rekom<?php echo $dt->id_lapangan;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		...
		<!-- End List Lapangan Hasil Pencarian -->
